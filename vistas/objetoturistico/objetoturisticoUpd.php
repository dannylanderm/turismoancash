...
<table class='form_data'>
    <tr>
        <td><label for='txtObjNombre'>Nombre:</label></td>
    ...
    <tr>
        <td><label for='txtObjTipoobjID'>Tipo de objeto turístico:</label></td>
    ...
    <tr>
        <td><label for='txtObjFoto'>Foto:</label></td>
        <td><input type='text' class='form-control txt250' id='txtObjFoto' name='txtObjFoto'
                   value='<?php if ($obj_row) {
			           echo htmlspecialchars($obj_row['obj_foto']);
		           } ?>' maxlength='256' placeholder='Ingrese foto'/></td>
    </tr>
    <tr>
        <td><label for='txtObjComentario'>Comentario:</label></td>
        <td><input type='text' class='form-control txt250' id='txtObjComentario' name='txtObjComentario'
                   value='<?php if ($obj_row) {
			           echo htmlspecialchars($obj_row['obj_comentario']);
		           } ?>' maxlength='500' placeholder='Ingrese comentario'/></td>
    </tr>
    <tr>
        <td><label for='txtObjFechaDatacion'>Fecha datacion:</label></td>
        <td><input type='text' class='form-control txt250' id='txtObjFechaDatacion' name='txtObjFechaDatacion'
		           ...
		           } ?>' placeholder='Ingrese fecha datacion'/></td>
    </tr>
    <tr>
    ...
    <tr hidden>
        <td><label for='txtObjEstado'>Estado:</label></td>
        <td><input type='text' class='form-control txt250' id='txtObjEstado' name='txtObjEstado'
                   value='<?php if ($obj_row) {
			           echo $obj_row['obj_estado'];
