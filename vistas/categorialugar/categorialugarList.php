...
?>
<table id='tblcategorialugar' class='table table-responsive'>
	<tr>
		<th>ID</th>
		<th>Nombre</th>
		<th hidden>Estado</th>
	...
	<tr>
		...
		<td class='txt_center'>
            <a href='#' class='btn btn-info' onclick="catlug_editar('<?php echo $row['catlug_id']; ?>');">
                <img src='../resources/img/edit.png' style='width: 16px;'>
            </a>
        </td>
		<td class='txt_center'>
            <a href='#'  class='btn btn-danger' onclick="catlug_borrar('<?php echo $row['catlug_id']; ?>');">
