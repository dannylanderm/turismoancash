...
<table class='form_data'>
    ...
    <tr>
        ...
        <td><input type='text' class='form-control txt250' id='txtUsuNombre' name='txtUsuNombre'
                   value='<?php if ($usu_row) {
			           echo htmlspecialchars($usu_row['usu_nombre']);
		           } ?>' maxlength='30' placeholder='Ingrese nombre'/></td>
    </tr>
    <tr hidden>
        <td><label for='txtUsuContrasena'>Contrasena:</label></td>
    ...
    <tr hidden>
        ...
        <td><input type='text' class='form-control txt250' id='txtUsuFechaAcceso' name='txtUsuFechaAcceso'
                   value='<?php if ($usu_row) {
			           echo formatDate($usu_row['usu_fecha_acceso']);
		           } ?>' placeholder='Ingrese fecha acceso'/></td>
    </tr>
    <tr hidden>
        <td><label for='txtUsuEstado'>Estado:</label></td>
        <td><input type='text' class='form-control txt250' id='txtUsuEstado' name='txtUsuEstado'
                   value='<?php if ($usu_row) {
			           echo $usu_row['usu_estado'];
