...
<tr>
    ...
    <td><select class='form-control txt250' id='txtLugTipolugID' name='txtLugTipolugID'> <!-- maxlength='10' -->
			...
			<?php $tipolug_list = $tipolug_dal->listarcbo(); ?>
...
<tr>
    ...
    <td><textarea id='txtLugDescripcion' name='txtLugDescripcion' maxlength='400' rows='4'
                  class='form-control' placeholder='Descripción del lugar'></textarea>
    </td>
</tr>
<tr>
    <td><label for='txtLugResenia'>Historia:</label></td>
    <td><textarea id='txtLugResenia' name='txtLugResenia' maxlength='500' rows='6'
                  class='form-control' placeholder='Breve descripción histórica del lugar (opcional)'></textarea>
...
<tr>
    ...
    <td><select class='form-control txt250' id='txtLugTipoingID' name='txtLugTipoingID'> <!-- maxlength='10' -->
            <option value='0'>(Seleccione)</option>
			<?php $tipoing_list = $tipoing_dal->listarcbo(); ?>
...
<tr>
    ...
    <td><input type='text' class='form-control txt120 inline' id='txtLugLatitudGeo' name='txtLugLatitudGeo' maxlength='16'
               placeholder='Latitud'/>
        <input type='text' class='form-control txt120 inline' id='txtLugLongitudGeo' name='txtLugLongitudGeo' maxlength='16'
...
<tr>
    ...
    <td><input type='text' class='form-control txt120 inline' id='txtLugTamanioArea' name='txtLugTamanioArea'
               maxlength='9' placeholder='Área (Km2)'/> Km2
    </td>
</tr>
<tr hidden>
...
<tr hidden>
    ...
    <td><input type='text' class='form-control txt250' id='txtLugCalificacion' name='txtLugCalificacion'
               value='0' placeholder='Ingrese calificacion'/></td>
</tr>
<tr hidden>
    ...
    <td><input type='text' class='form-control txt250' id='txtLugSituacion' name='txtLugSituacion'
               value='1' placeholder='Ingrese situacion'/></td>
</tr>
</table>
</div>
<div class='inline txt_left' style='vertical-align: top;'>
    ...
    <div class='rpad3'>
        <img id='imgLugFoto' style='width: 333px;' src='../resources/img/utils/img_80x120.png'
...
$(document).ready(function (e) {
    ...
    $(lug_reg).find('#btnRegistrar').off('click').click(function (e) {
        if (lug_validar()) {
            ...
            $.ajax({
                url        : 'lugarturistico/proceso/lugarturistico_insert.php',
                type       : 'POST',
                contentType: false,
                data       : form_data,
                processData: false,
