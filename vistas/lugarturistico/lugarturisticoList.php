...
<?php foreach ($lug_list as $row) { ?>
    <tr>
        ...
        <td class='txt_right'> <?php echo DECtoDMS($row['lug_latitud_geo'], true); ?></td>
        <td class='txt_right'> <?php echo DECtoDMS($row['lug_longitud_geo'], true); ?></td>
        <td class='txt_right'> <?php echo int_vformat($row['lug_altitud']); ?> msnm</td>
        <!-- <td class='txt_right'> --><?php //echo $row['lug_tamanio_area']; ?><!--</td>-->
        <td><img src='<?= "../$row[lug_foto]"; ?>' style='width: 100px;' alt=''></td>
