...
<table class='form_data'>
	...
	<tr><td><label for='txtGalFoto'>Foto:</label></td>
		<td><input type='text' class='form-control txt200' id='txtGalFoto' name='txtGalFoto' maxlength='256' placeholder='Ingrese foto'/></td>
	</tr>
	<tr><td><label for='txtGalFotoDescripcion'>Foto descripcion:</label></td>
		<td><input type='text' class='form-control txt200' id='txtGalFotoDescripcion' name='txtGalFotoDescripcion' maxlength='500' placeholder='Ingrese foto descripcion'/></td>
	</tr>
</table>
<hr class='separator'/>
<div class='form_foot'>
